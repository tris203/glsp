...
type Handler_316 struct {
	...
	// General Messages
	Initialize  InitializeFunc[InitializeParams_316, InitializeResult_316]
...
func (h *Handler_316) GetMethodMap() map[Method]glsp.HandlerInterface {
...
func (h *Handler_316) CreateServerCapabilities() ServerCapabilities_316 {
	var capabilities ServerCapabilities_316
