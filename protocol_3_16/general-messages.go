...
func (c *ClientCapabilities) SupportsSymbolKind(kind SymbolKind) bool {
	var kinds []SymbolKind
	if (c.TextDocument != nil) && (c.TextDocument.DocumentSymbol != nil) && (c.TextDocument.DocumentSymbol.SymbolKind != nil) {
		kinds = c.TextDocument.DocumentSymbol.SymbolKind.ValueSet
	}
	if kinds == nil {
		return kind <= 19
	} else {
